  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        menuType: form.menuType || "main",

        showInNavbar: Boolean(form.showInNavbar),

        showInHomeSlider: Boolean(form.showInHomeSlider),
      };
            ...
            <table className="min-w-[1000px] w-full text-left text-sm">
              <thead className="bg-[#f3f7fb] text-xs uppercase text-slate-500">
                <tr>
                  ...
                  <th className="px-4 py-4">Navbar</th>
              ...
              <tbody className="divide-y">
                {filtered.map((cat) => (
                  <tr key={cat._id} className="hover:bg-slate-50">
                    ...
                    <td className="px-4 py-4">
                      <span
                        className={`rounded-full px-3 py-1 text-xs font-bold ${cat.isActive
                ...
                <Field label="Image URL">
                  <div className="space-y-2">
                    <input
                      ...
                      placeholder="/uploads/categories/category-image.jpg"
                    />
                ...
                <label className="flex items-center gap-2 rounded-xl border px-4 py-3">
                  <input
                    ...
                    onChange={(e) =>
                      setForm((p) => ({
                        ...p,
                        showInHomeSlider: e.target.checked,
                      }))
                    }
                  />
                  Show On Homepage
