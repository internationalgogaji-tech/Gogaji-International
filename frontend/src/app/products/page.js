              ...
              {allCategories
                .map((item) => (
                  <Link
                    ...
                    className="rounded-full border border-[#d6bd72] px-5 py-3 text-[15px] font-semibold text-[#1f604d] transition hover:bg-[#14532d] hover:text-white hover:border-[#14532d]"                  >
                    {item.name}
                  </Link>
                ))}
            </div>
