      ...
      <main className="bg-white">
            ...
            <div className="relative min-h-[420px] overflow-hidden rounded-sm bg-[#072e5d] md:min-h-[520px]">
              ...
              <div className="relative flex h-full max-w-3xl flex-col justify-end p-8 text-white md:p-12">
                <p className="mb-4 inline-flex w-fit items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-black text-blue-800">
                  <BookOpen size={17} />
                  Gogaji Decor Journal
                </p>

                <h1 className="text-4xl font-black leading-tight md:text-6xl">
                  Home Decor, Styling Ideas & Luxury Living Inspiration
                </h1>

                <p className="mt-5 max-w-2xl text-base leading-8 text-blue-50">
                  Discover home decor trends, styling inspiration,
                  luxury gifting ideas, interior design tips and
                  premium living solutions from Gogaji International.
                </p>
              ...
              <div className="overflow-hidden rounded-sm border border-slate-200 bg-white">
                ...
                <div className="p-5">
                  ...
                  <h2 className="mt-2 text-2xl font-black leading-tight text-slate-950">
                    {featuredBlog?.title ||
                      "Luxury Home Decor Buying Guide"}
                  </h2>
                </div>
              </div>
            </aside>
        ...
        <section className="mx-auto max-w-[1500px] px-5 py-10 xl:px-8">
          <div className="grid gap-8 lg:grid-cols-2">
            <BigBlock title="Decor Styling Guides" blogs={semiconductorBlogs} />
            <BigBlock title="Buying Guide" blogs={automationBlogs} />
            <BigBlock
              title="Home Decor Buying Guide"
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <p className="mt-3 line-clamp-2 text-sm leading-6 text-slate-600">
                      {cat.description ||
                        "Explore home decor inspiration, styling ideas, luxury gifting solutions and interior trends."}
                    </p>
          ...
          <div className="grid overflow-hidden rounded-sm bg-gradient-to-r from-[#062a54] via-[#075b9d] to-[#13b8f0] text-white lg:grid-cols-[1fr_420px]">
            <div className="p-8 md:p-12">
              ...
              <p className="mt-5 max-w-3xl text-base leading-8 text-blue-50">
                Discover premium home decor collections,
                luxury gifting products, decorative accessories,
                planters, vases and elegant interior styling solutions.
              </p>
            ...
            <div className="min-h-[280px]">
              <img
                src="/banner/home-decor-banner.jpg"
