...
export default function CategoryManager({ title, subtitle, level = "main" }) {
  ...
  const openEdit = (cat) => {
    ...
    setForm({
      ...
      showInHomeSlider: cat.showInHomeSlider ?? false,
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Field label="Navbar Order">
                <input
                  ...
                  onChange={(e) =>
                    updateForm("navbarOrder", Number(e.target.value))
                  }
                />
              </Field>

              <div className="md:col-span-2 flex flex-wrap gap-6 rounded-xl border p-4">
                <label className="flex items-center gap-2 font-semibold">
                  <input
                    type="checkbox"
                    checked={form.showInNavbar}
                    onChange={(e) =>
                      updateForm("showInNavbar", e.target.checked)
                    }
                  />
                  Show In Navbar
                </label>
                ...
                <label className="flex items-center gap-2 font-semibold">
                  <input
                    ...
                    onChange={(e) =>
                      updateForm("showInHomeSlider", e.target.checked)
                    }
                  />
