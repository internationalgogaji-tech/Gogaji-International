...
exports.forgotPassword = async (req, res) => {
  ...
  html: `
    <h2>Gogaji International Admin Login</h2>
    <h1>${otp}</h1>
...
exports.adminSendOtp = async (req, res) => {
  ...
  console.log("ADMIN SEND OTP HIT");
...
console.log("EMAIL FROM REQUEST =", email);
console.log("EMAIL LOWER =", email.toLowerCase().trim());
...
console.log("SEARCH EMAIL =", JSON.stringify(searchEmail));
...
console.log("OTP FROM =", process.env.OTP_FROM_EMAIL);
